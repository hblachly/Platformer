...
public class SignInSceneController {
    ...
    //Loads menu when user clicks the back button from Sign Up scene
    @FXML
    void loadMenu(ActionEvent event)
    {
    	 ViewNavigator.loadScene("Sign Up", ViewNavigator.MENU_SCENE);
    }
    ...
    public boolean signIn(ActionEvent event) {
        ...
        ViewNavigator.loadScene("Leaderboard", ViewNavigator.MENU_USER_SCENE);
        return true;
    }
